...
import 'package:learninghub/screens/home/chat_rooms.dart';
import 'package:learninghub/screens/home/browser.dart';
import 'package:learninghub/screens/home/education.dart';
import 'package:learninghub/screens/home/entertainment.dart';
import 'package:learninghub/screens/home/games.dart';
import 'package:learninghub/screens/home/youtube.dart';
import 'package:snippet_coder_utils/FormHelper.dart';
import 'package:learninghub/Config.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
        ...
        actions: <Widget>[
                  ...
                  onTap: ()  async{
                    ...
                    final response = await http.post(
                      Uri.parse(Config.apiURL+'/api/myaccess'),
    ...
    if ( items[index]["itemname"] == "YouTube") {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) =>  youtube( myaccess:myaccess)),
        );
        }else{
